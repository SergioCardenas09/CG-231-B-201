...
/**
 * RotacionX: Crea la matriz de rotacion "matrisrotx" a partir de "rx"
 * Entrada: rx=vector de rotacion (arreglo 3 enteros)
 * Salida: matriz: Matriz de escalado generada apartir de vt
 */
...
/**
 * Rotaciony: Crea la matriz de rotacion "matrisroty" a partir de "ry"
 * Entrada: ry=vector de rotacion (arreglo 3 enteros)
 * Salida: matriz: Matriz de escalado generada apartir de vt
 */
...
/**
 * Rotacionz: Crea la matriz de rotacion "matrisrotz" a partir de "rz"
 * Entrada: ry=vector de rotacion (arreglo 3 enteros)
 * Salida: matriz: Matriz de escalado generada apartir de vt
 */
 ...
 * Salida: obj actualizado
 */
function RotacionRealenx (obj, vp, vs, angulo) {
 ...
 * Salida: obj actualizado
 */
function RotacionRealenz(obj, vp, vs, angulo) {
    var vt = [-vp[0], -vp[1], -vp[2]];
    obj.applyMatrix(Traslacion(vt));
 ...
 * Salida: obj actualizado
 */
function RotacionRealeny (obj, vp, vs, angulo) {
    var vt = [-vp[0], -vp[1], -vp[2]];
    obj.applyMatrix(Traslacion(vt));
...
function init() {
    ...
    RotacionRealenz(fig[1],vt,[1,-1,1],90);
    
    RotacionRealeny(fig[0],vt,[1,-1,1],-90);
    RotacionRealenz(fig[0],vt,[1,-1,1],-90);
